...
public class QnAReplyController {
	...
	public String insert(QnAReplyDTO rdto) {
		...
		return "redirect:/qnaBoard/selectOnePost?qa_seq="+rdto.getQa_seq();
	}
	
	// 댓글 수정
	@RequestMapping("replyUpdate")
	public String update (QnAReplyDTO rdto) {
	...
	public String delete (int re_seq, int qa_seq) {
