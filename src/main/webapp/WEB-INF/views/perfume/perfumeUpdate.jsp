...
<body>
    <form action="/perfume/perfumeUpdate" method='post' enctype="multipart/form-data">
    <div class="container">
        <div class="row">
            <div class="col">
                <h1>향수 정보 입력</h1>
        ...
        <div class="row ">
            <div class="col-12">
                ...
                <div id="imgOutLine" >
                <img src="/perfumeImage/${file.sysName}" id="image"/>
                </div>
                </div>
            </div>
        ...
        <div class="row ">
            ...
            <input type="hidden" name="per_seq" value="${perfume.per_seq}" >
                ...
                <input class="form-control w-75 h-75 d-inline-block" type="text" name="per_name" value="${perfume.per_name}"placeholder="향수명">
            </div>
        </div>
        <div class="row ">
            <div class="col-12">
                <span class="badge bg-secondary w-25 p-3 h-75 d-inline-block">브랜드</span>
                <input type="text" class="form-control w-75 h-75 d-inline-block" name="per_brand" value="${perfume.per_brand}" placeholder="브랜드명">
            </div>
        </div>
        <div class="row ">
            <div class="col-12">
                <span class="badge bg-secondary w-25 p-3 h-75 d-inline-block">용량</span>
                <input type="text" class="form-control w-75 h-75 d-inline-block" name="per_volume" value="${perfume.per_volume}" placeholder="용량">
            </div>
        </div>
        <div class="row ">
            <div class="col-12">
        ...
        <div class="row ">
            <div class="col-12">
                ...
                <input  type="text" class="form-control w-75  h-75 d-inline-block" name="per_price" value="${perfume.per_price}" placeholder="가격">
            </div>
        </div>
        <div class="row ">
            <div class="col-12">
        ...
        <div class="row ">
            <div class="col-12 input-group">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions" value="${perfume.top1}" name="top1">
        ...
        <div class="row ">
            <div class="col-12 input-group">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions"  value="${perfume.top2}" name="top2">
                <button class="btn btn-outline-secondary h-75" type="button" id="button-addon2">버튼</button>
            </div>
        </div>
        <div class="row ">
            <div class="col-12 input-group mb-3">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions"  value="${perfume.top3}" name="top3">
        ...
        <div class="row ">
            <div class="col-12 input-group">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions" value="${perfume.middle1}" name="middle1">
                <datalist class="datalistOptions">
                </datalist>
                <button class="btn btn-outline-secondary h-75" type="button" id="button-addon2">버튼</button>
            </div>
        ...
        <div class="row ">
            <div class="col-12 input-group">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions" value="${perfume.middle2}" name="middle2">
                <datalist class="datalistOptions">
                </datalist>
                <button class="btn btn-outline-secondary h-75" type="button" id="button-addon2">버튼</button>
            </div>
        ...
        <div class="row ">
            <div class="col-12 input-group mb-3">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions" value="${perfume.middle3}" name="middle3">
                <datalist class="datalistOptions">
                </datalist>
                <button class="btn btn-outline-secondary h-75" type="button" id="button-addon2">버튼</button>
            </div>
        ...
        <div class="row ">
            <div class="col-12 input-group">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions" value="${perfume.base1}" name="base1">
                <datalist class="datalistOptions">
                </datalist>
                <button class="btn btn-outline-secondary h-75" type="button" id="button-addon2">버튼</button>
            </div>
        ...
        <div class="row ">
            <div class="col-12 input-group">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions" value="${perfume.base2}" name="base2">
                <datalist class="datalistOptions">
                </datalist>
                <button class="btn btn-outline-secondary h-75" type="button" id="button-addon2">버튼</button>
            </div>
        ...
        <div class="row ">
            <div class="col-12 input-group mb-3">
                ...
                <input type="text" class="form-control h-75"  list="datalistOptions" value="${perfume.base3}"  name="base3">
                <datalist class="datalistOptions">
                </datalist>
                <button class="btn btn-outline-secondary h-75" type="button" id="button-addon2">버튼</button>
            </div>
        ...
        <div class="row"><button type="submit">수정완료</button></div>
