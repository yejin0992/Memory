...
<body>
	<form action="/perfume/perfumeUpdate" method='post'
		...
		<div class="container">
			...
			<div class="row ">
				<div class="col-12">
					...
					<input class="form-control w-75 h-75 d-inline-block" type="text"
						name="per_name" value="${perfume.per_name}" placeholder="향수명">
				</div>
			</div>
			<div class="row ">
				<div class="col-12">
					<span class="badge bg-secondary w-25 p-3 h-75 d-inline-block">브랜드</span>
					<input type="text" class="form-control w-75 h-75 d-inline-block"
						name="per_brand" value="${perfume.per_brand}" placeholder="브랜드명">
				</div>
			</div>
			<div class="row ">
				<div class="col-12">
					...
					<input type="text" class="form-control w-75 h-75 d-inline-block"
						name="per_volume" value="${perfume.per_volume}" placeholder="용량">
				</div>
			</div>
			<div class="row ">
				<div class="col-12">
			...
			<div class="row ">
				<div class="col-12">
					...
					<input type="text" class="form-control w-75  h-75 d-inline-block"
						name="per_price" value="${perfume.per_price}" placeholder="가격">
				</div>
			</div>
			<div class="row ">
				<div class="col-12">
			...
			<div class="row ">
				<div class="col-12 input-group">
					...
					<input type="text" class="form-control h-75" list="datalistOptions"
						value="${perfume.top1}" name="top1">
			...
			<div class="row ">
				<div class="col-12 input-group">
					...
					<input type="text" class="form-control h-75" list="datalistOptions"
						value="${perfume.middle1}" name="middle1">
					<button class="btn btn-outline-secondary h-75 reChoice"
						type="button">재선택</button>
					<button class="btn btn-outline-secondary h-75 searchNote"
						type="button">찾기</button>
			...
			<div class="row ">
				<div class="col-12 input-group">
					...
					<input type="text" class="form-control h-75" list="datalistOptions"
						value="${perfume.middle2}" name="middle2">
					<button class="btn btn-outline-secondary h-75 reChoice"
						type="button">재선택</button>
					<button class="btn btn-outline-secondary h-75 searchNote"
						type="button">찾기</button>
			...
			<div class="row ">
				<div class="col-12 input-group mb-3">
					...
					<input type="text" class="form-control h-75" list="datalistOptions"
						value="${perfume.middle3}" name="middle3">
					<button class="btn btn-outline-secondary h-75 reChoice"
						type="button">재선택</button>
					<button class="btn btn-outline-secondary h-75 searchNote"
						type="button">찾기</button>
			...
			<div class="row ">
				<div class="col-12 input-group">
					...
					<input type="text" class="form-control h-75" list="datalistOptions"
						value="${perfume.base1}" name="base1">
					<button class="btn btn-outline-secondary h-75 reChoice"
						type="button">재선택</button>
					<button class="btn btn-outline-secondary h-75 searchNote"
						type="button">찾기</button>
			...
			<div class="row ">
				<div class="col-12 input-group">
					...
					<input type="text" class="form-control h-75" list="datalistOptions"
						value="${perfume.base2}" name="base2">
					<button class="btn btn-outline-secondary h-75 reChoice"
						type="button">재선택</button>
					<button class="btn btn-outline-secondary h-75 searchNote"
						type="button">찾기</button>
			...
			<div class="row ">
				<div class="col-12 input-group mb-3">
					...
					<input type="text" class="form-control h-75" list="datalistOptions"
						value="${perfume.base3}" name="base3">
					<button class="btn btn-outline-secondary h-75 reChoice"
						type="button">재선택</button>
					<button class="btn btn-outline-secondary h-75 searchNote"
						type="button">찾기</button>
