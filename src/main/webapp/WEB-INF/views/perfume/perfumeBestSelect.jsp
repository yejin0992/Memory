	...
	<div class="container">
		...
		<div class="row informationRow">
			<div class="col-6 informationCol">
				<img src="/perfumeImage/${file.sysName}" id="perfumeImage"
					class="img-fluid">
				<div class="heartCol">
					<input type="hidden" class="per_seq" name="per_seq"
						value="${perfume.per_seq}">
					<c:choose>
						<c:when test="${heart == 0}">
		...
		<div class="row justify-content-center">
			<div class="col-sm-12 col-md-9 col-lg-7 d-flex g-start-2"
				id="pyramid">
				<img src="/resources/pyramid.png" class="img-fluid ">
			...
			<div class="col replyListCol">
				<c:forEach var="i" items="${reply}">
					<form action="/perfumeReply/update" method="post"
						class="row messageSelect">
						<div class="col-12 replyIdCol">
							<input type="text" class="replyIdRow" name="id" value="${i.id}"
								readonly> <span id="formDate">${i.formedDate}</span>
						</div>
						<div class="col-12 replyConCol">
							<textarea class="row replyConRow autosize" name="contents"
								maxlength="100" readonly>${i.contents}</textarea>
							<input type="hidden" name="cpage" value="0"> <input
								type="hidden" name="per_seq" value="${i.per_seq}"> <input
								type="hidden" name="re_seq" value="${i.re_seq}">
						</div>
						<c:if test="${loginID eq i.id}">
							<div class="row replyRow">
								<div class="col d-flex flex-row-reverse">
									...
									<a
										href="/perfumeReply/delete?re_seq=${i.re_seq}&per_seq=${perfume.per_seq}&cpage=0">
										<button type="button" class="replyDelBtn replyBtn"
											id="${i.re_seq}">삭제</button>
									</a>
			...
			<div class="col">
				<div class="row messageBox messageBorder">
					<form action="/perfumeReply/insert" method="post">
						...
						<textarea id="replyInput" class="col-12 autosize" name="contents"
							maxlength="100" placeholder="댓글을 입력해주세요."></textarea>
